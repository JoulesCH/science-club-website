...
export default function (){
        ...
        <div className="md:grid md:grid-cols-3 md:gap-6">
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              ...
              Usa tus conocimientos y tu creatividad para divulgar algún concepto sobre ciencia de
              tu interés y que su alcance llegue de nuestros compañeros más pequeños y que no se
              queden sin disfrutar de este maravilloso mundo.
              <br/>
                <br/>
              
              El Club de Divulgación presenta su primer concurso de divulgación abierto a toda la
              comunidad estudiantil de la Escuela Superior de Física y Matemáticas con el fin de
              llevar conocimiento a niveles educativos como secundaria y primaria. Haciendo el
              concurso a tu alcance, se convocan dos categorías: vídeo estilo TikTok y modalidad
              escrita (tira cómica, caricatura o cuento), explicadas en la sección CATEGORÍAS. 
                ...
                <div className="bg-white px-4 py-5 sm:p-6">
                  <div className="grid grid-cols-6 gap-6">
                    ...
                    <div className="col-span-6">
                        ...
                        />
                        <label htmlFor="accept" className=" text-sm font-medium text-gray-700 "> He leído y acepto el <a href="/avisodeprivacidad.pdf" className="text-[#FF9400] underline">aviso de privacidad</a> </label>
                    </div>
                  </div>
                  {messageSent}
                </div>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" preserveAspectRatio="none" viewBox="0 0 1680 40" aria-hidden="true" className="relative w-full z-1 mt-[-5px]" style={{transform: "scaleY(-1)"}}><path d="M0 40h1680V30S1340 0 840 0 0 30 0 30z" fill="#1b2a2f"></path></svg>
